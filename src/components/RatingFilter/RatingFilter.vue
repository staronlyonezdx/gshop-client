<template>
  <div class="ratingselect">
    <div class="rating-type border-1px">
      <span class="block" @click="setSelectRateType(2)" :class="{active:selectRateType === 2}">
        全部<span class="count">{{ratingsTotalCount}}</span>
      </span>
      <span class="block " @click="setSelectRateType(0)" :class="{active:selectRateType === 0}">
        推荐<span class="count">{{ratingsPositiveCount}}</span>
      </span>
      <span class="block" @click="setSelectRateType(1)" :class="{active:selectRateType === 1}">
